...
hl.animation({ leaf = "windows",       enabled = false,  speed = 2.5, bezier = "easeOutQuint" })
...
hl.animation({ leaf = "workspaces",    enabled = false,  speed = 0, bezier = "almostLinear", style = "fade" })
hl.config({
    dwindle = {
